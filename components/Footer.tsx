        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
           ...
           <div>
            ...
            <ul className="space-y-4 text-lychy-200 text-sm">
              <li className="flex items-start space-x-3 group">
                ...
                <a href="mailto:lychydev@gmail.com" className="hover:text-white transition-colors break-all">lychydev@gmail.com</a>
              </li>
              <li className="flex items-start space-x-3 group">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 text-white flex items-center justify-center hover:bg-lychy-400/10 hover:border-lychy-400/50 hover:text-lychy-400 hover:scale-110 transition-all">
                <Github size={20} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 text-white flex items-center justify-center hover:bg-lychy-400/10 hover:border-lychy-400/50 hover:text-lychy-400 hover:scale-110 transition-all">
                <Linkedin size={20} />
