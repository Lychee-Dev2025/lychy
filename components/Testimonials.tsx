...
const testimonials: Testimonial[] = [
  {
    ...
    content: "Lychy transformed our outdated platform into a modern, high-speed web app. Their attention to detail is unmatched, and the transition was seamless for our users.",
    rating: 5,
  },
  {
    id: '2',
    ...
    content: "We needed a partner who could grasp complex fintech requirements and deliver a secure, scalable solution. Lychy exceeded our expectations in every regard.",
    rating: 5,
  },
  {
    id: '3',
    ...
    content: "They didn't just build an app; they understood our mission. The user experience they designed has helped us increase engagement by over 200%.",
    rating: 5,
  },
  {
    id: '4',
    ...
    content: "The LMS platform Lychy built for us is incredibly robust. It handles thousands of concurrent students without a hitch. Highly recommended.",
    rating: 5,
  },
  {
    id: '5',
    ...
    role: 'Product Lead',
    company: 'HealthVibe',
    content: "Professional, responsive, and technically brilliant. They took our telemedicine concept and turned it into a reality in record time.",
    rating: 5,
  }
];
